...
class SecondViewController: UIViewController
{
    ...
    func configureStartUpUI()
    {
        ...
        for x in MovieDetails.movie.selectedSongTitle
        {
          ...
          // play and pause button creation
            ...
            // play and pause button constraints
    ...
    @objc func playAndPauseButtonEH(button:UIButton)
    {
        ...
        {
            let alert = UIAlertController(title: "ALERT", message: "Two Songs Can't Play At A Time", preferredStyle: UIAlertController.Style.alert)
